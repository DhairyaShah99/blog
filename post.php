    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            while ($post = mysqli_fetch_assoc($all_posts_result)) {
                ...
                <!-- Blog Post -->
                <div class="card mb-4">
                    <img class="card-img-top image-fluid" src="images/<?php echo $post_image;?>" alt="<?php echo $post_title;?>">
                    <div class="card-body">
                        <h2 class="card-title">
